                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('customers.index')); ?>"class="breadcrumb-link">Customer List</a></li>
                ...
                <div class="card-body">
                    <div id="resultMessage" style="font-size:18px;color:red;"></div>
                        <form id="addcustomer" method="post"
                            action="<?php echo e(route('customers.update', $customers->id)); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="row">
                                <div class="col">
                                    <label for="fname">Name <span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="name" value="<?php echo e($customers->name); ?>" class="form-control" placeholder="Enter your name" >
                                </div>
                                <div class="col">
                                    <label for="email">Email <span class="text-danger">*</span></label>
                                    <input type="email" name="email" id="email" value="<?php echo e($customers->email); ?>" class="form-control" onkeyup="checkEmail(event.target.value)" placeholder="Enter your Email">
                                </div>
                                <div class="col">
                                    <label for="number">Number<span class="text-danger">*</span></label>
                                    <input type="text" name="number" id="number" value="<?php echo e($customers->phonenumber); ?>" class="form-control" placeholder="Enter your Number"  onkeyup="checknumber(event.target.value)">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <label for="premiumamount">Premium Amount<span class="text-danger">*</span></label>
                                    <input type="text" name="premiumamount" id="premiumamount" value="<?php echo e($customers->premiumamount); ?>" class="form-control" onkeyup="checkEmail(event.target.value)" placeholder="Enter your Premium Amount">
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="gstamount" id="gstamount" value="<?php echo e($customers->gstamount); ?>" class="form-control" placeholder="Enter your GST Amount" readonly>
                                </div>
                            </div>
                            <div class="row mt-4 ">
                                <div class=" col form-group">
                                    <label for="totalpremiumamount">Total Premium Amount<span class="text-danger">*</span></label>
                                    <input type="text" name="totalpremiumamount" id="totalpremiumamount" value="<?php echo e($customers->totalpremiumcollected); ?>" class="form-control" placeholder="Enter your Total Premium Amount" readonly>
                                </div>
                            </div> 
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrm_app\resources\views/admin/dashboard/edit.blade.php ENDPATH**/ ?>