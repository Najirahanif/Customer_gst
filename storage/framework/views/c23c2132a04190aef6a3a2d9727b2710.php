...
<img src="" alt="Logo" loading="lazy" class="right-align">
    <h2 class="content-title card-title" style="float: left;">Employee List</h2>
</div>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td  scope="col" class="text-center"><?php echo e(ucfirst(strtolower($employee->fname))); ?></td>
                <td scope="col" class="text-center"><?php echo e(ucfirst($employee->status)); ?></td>
            </tr>
        <?php $i++; ?>
...
<?php /**PATH E:\xampp\htdocs\hrm_app\resources\views/admin/employee/export.blade.php ENDPATH**/ ?>