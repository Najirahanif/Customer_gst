...
<img src="" alt="Logo" loading="lazy" class="right-align">
    <h2 class="content-title card-title" style="float: left;">Department List</h2>
</div>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td  scope="col" class="text-center"><?php echo e(ucfirst(strtolower($department->name))); ?></td>
                <td  scope="col" class="text-center"><?php echo e(ucfirst(strtolower($department->designation))); ?></td>
               <td scope="col" class="text-center"><?php echo e(ucfirst($department->status)); ?></td>
            </tr>
        <?php $i++; ?>
...
<?php /**PATH D:\xampp\htdocs\hrm_app\resources\views/admin/department/export.blade.php ENDPATH**/ ?>