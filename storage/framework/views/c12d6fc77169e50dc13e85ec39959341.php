    ...
    <tbody>
        ...
        <?php $__currentLoopData = $designation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td  scope="col" class="text-center"><?php echo e(ucfirst(strtolower($designation->description))); ?></td>
...
<?php /**PATH D:\xampp\htdocs\hrm_app\resources\views/admin/designation/export.blade.php ENDPATH**/ ?>