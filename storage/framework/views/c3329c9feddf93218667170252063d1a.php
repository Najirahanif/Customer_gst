        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link <?php echo e(request()->routeIs([
                    'department.*'])  ? 'active' : ''); ?>" href="/departmentlist"><i class="fas fa-fw fa-chart-pie"></i>Department <span class="badge badge-success">6</span></a>
                    </li>
...
<?php /**PATH D:\xampp\htdocs\hrm_app\resources\views/includes/admin/sidebar.blade.php ENDPATH**/ ?>