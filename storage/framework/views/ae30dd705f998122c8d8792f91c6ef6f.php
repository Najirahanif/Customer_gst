                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <input type="text" class="form-control" name="description" id="description" placeholder="Enter designation "  value="<?php echo e($designation->description); ?>" >
                            </div>
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrm_app\resources\views/admin/designation/edit.blade.php ENDPATH**/ ?>