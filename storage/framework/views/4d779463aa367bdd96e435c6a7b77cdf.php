                ...
                <div class="card-body">
                    <div id="resultMessage" style="font-size:18px;color:red;"></div>
                        <form id="addcustomer" method="post"
                            action="<?php echo e(route('customers.store')); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="premiumamount" id="premiumamount" class="form-control" onkeyup="checkEmail(event.target.value)" placeholder="Enter your Premium Amount">
                                </div>
                                <div class="col">
                                    <label for="gstpercent">GST Percent<span class="text-danger">*</span></label>
                                    <input type="text" name="gstpercent" id="gstpercent" class="form-control" placeholder="Enter your GST in %" value="18" oninput="checkgstpercent(this.value)">
                                </div>
                                <div class="col">
                                    <label for="gstamount">GST Amount<span class="text-danger">*</span></label>
                                    <input type="text" name="gstamount" id="gstamount" class="form-control" placeholder="Enter your GST Amount" readonly>
                                </div>
                            </div>
                            <div class="row mt-4 ">
                                <div class=" col form-group">
                                    <label for="totalpremiumamount">Total Premium Amount<span class="text-danger">*</span></label>
                                    <input type="text" name="totalpremiumamount" id="totalpremiumamount" class="form-control" placeholder="Enter your Total Premium Amount" readonly>
                                </div>
                            </div> 
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrm_app\resources\views/admin/dashboard/create.blade.php ENDPATH**/ ?>